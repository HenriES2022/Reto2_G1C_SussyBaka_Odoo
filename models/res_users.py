...
class ResUsers(models.Model):
    ...
    coments = fields.One2many('sussy_baka.comment', 'student_id',string="Coments",
    ...
    teaching_courses = fields.One2many('sussy_baka.course', 'teacher_id',string="Teaching courses", help="The courses that the teacher is teaching")
